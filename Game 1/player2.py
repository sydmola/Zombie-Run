...
class Player2(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.forward_image = pygame.image.load("../assets/sprites/player_stand.png")
        self.reverse_image = pygame.image.load("../assets/sprites/player_back.png")
        self.hurt_image = pygame.image.load("../assets/sprites/player_hurt.png")
